...
C       ONLY NEEDS TO BE DONE FOR NON-PARAMETER RIVERS
        DO L=1,NNPGHB
          IR=BNDS(2,L)
          IC=BNDS(3,L)
          IL=BNDS(1,L)
...
C2------IF CELL-BY-CELL FLOWS WILL BE SAVED AS A LIST, WRITE HEADER.
      IF(IBD.EQ.2) THEN
         ...
         IF(INCLN.GT.0) THEN
           ...
           NNCLNNDS=NCLNNDS
         ENDIF
         CALL UBDSVHDR(IUNSTR,KSTP,KPER,IOUT,IGHBCB,IICLNCB,NODES,
...
C5J-----FLOW TO BNDS.
   99 CONTINUE
      IF(IBD.EQ.2)THEN 
        CALL UBDSVREC(IUNSTR,N,NODES,NNCLNNDS,IGHBCB,IICLNCB,NGHBVL,
