C $Id: gwf2gag7.f 1457 2010-02-23 17:43:49Z rsregan $      
C
C-------SUBROUTINE GWF2GAG7U1AR
      SUBROUTINE GWF2GAG7U1AR(INGAGE,IUNITSFR,IUNITLAK)
C     ******************************************************************
...
C12-----RETURN.
999   RETURN
      END SUBROUTINE GWF2GAG7U1AR
C
C-------SUBROUTINE GWF2GAG7U1RP
      SUBROUTINE GWF2GAG7U1RP(IUNITGWT,IUNITLAK,IUNITUZF,NSOL)
C     ******************************************************************
...
cdep 4/20/2009 dimensioned SEEP array to nlakes
     ...
     1          VOLOLD(NLAKES),CLKOLD(1,1),CLAKINIT(1,1)
      DOUBLE PRECISION SEEP(NLAKES)
      CHARACTER*1256  LFRMAT
      ALLOCATABLE DELCTS(:,:),DELCCUM(:,:)
      ALLOCATE(DELCTS(1,1),DELCCUM(1,1))
C     ------------------------------------------------------------------
C
...
C
C-------SUBROUTINE GWF2GAG7U1DA      
      SUBROUTINE GWF2GAG7U1DA
