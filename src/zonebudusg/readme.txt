...
integer array reader.  Right now the arrays in the disu file 
must be read using CONSTANT, INTERNAL, or OPEN/CLOSE because 
it doesn't read the name file to get the file units for external files.
